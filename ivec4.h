...
inline void math_ivec4_copy ( const ivec4 input, ivec4 *output )
	{
...
inline void math_ivec4_add ( const ivec4 first, const ivec4 second, ivec4 *output )
	{
	for ( unsigned index = 0; index < 4; ++index )
		{
...
inline void math_ivec4_subtract ( const ivec4 first, const ivec4 second, ivec4 *output )
	{
	for ( unsigned index = 0; index < 4; ++index )
		{
		output->raw[index] = first.raw[index] - second.raw[index];
